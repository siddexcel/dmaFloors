...
<head>
<title>Floors for Manufacturing :: DMA Floors</title>
...
<main class="main-wrapper grid"><h1>Floors for Manufacturing and Industrial Facilities</h1>
  <div class="wrapper-left-right grid">
    <div class="sidebar-vertical-left"><?php include 'includes/menu-govt-military.php';?></div>
	<div class="content-center">Main Content Here</div>
    <div class="sidebar-vertical-right"><?php include 'includes/links-govt-military.php';?></div>
  </div>
</main>
<footer class="grid">
