...
<head>
<title>Resinous Flooring for Corporate Office Environments :: DMA Floors</title>
...
<main class="main-wrapper grid"><h1>Floors for Corporate and Office Environments</h1>
  <div class="wrapper-left-right grid">
    <div class="sidebar-vertical-left"><?php include 'includes/menu-corp-office.php';?></div>
	<div class="content-center">Main Content Here</div>
    <div class="sidebar-vertical-right"><?php include 'includes/links-corp-offce.php';?></div>
  </div>
</main>
<footer class="grid">
